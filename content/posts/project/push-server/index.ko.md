---
title: "게임 서비스를 위한 푸시 서버 개발기"
date: "2023-05-12T17:48:48+09:00"
lastmod: "2026-02-22T17:19:13+09:00"
description: "대상별 예약 발송과 푸시 지연 개선을 목표로 설계한 서버의 구조, 개발 과정과 프로젝트 중단까지 기록합니다."
summary: "대상별 예약 발송과 푸시 지연 개선을 목표로 설계한 서버의 구조, 개발 과정과 프로젝트 중단까지 기록합니다."
tags: ["게임펍", "푸시", "고 언어", "서버"]
categories: ["프로젝트"]
hero: "images/pushserver.png"
menu:
  sidebar:
    name: "게임 서비스를 위한 푸시 서버 개발기"
    identifier: push-server
    parent: project
    weight: 60
---
...
상태값은 대기, 진행중, 성공, 실패 로 나뉘며 분산처리는 [고루틴](https://coolishbee.github.io/techblog/go/go-goroutine/) 사용하였습니다.
...
![푸시 서버 구조](images/pushserver.png)
...
* 안드로이드 클라이언트가 백그라운드 상태에서도 푸시알림 팝업을 띄우려면 [푸시알림 설정]({{< relref "/posts/project/gamepub-sdk#push-notification-settings" >}})에 대해서도 알아야 합니다.
...
[기술 블로그에서 원문 보기](https://coolishbee.github.io/techblog/project/push-server/)
