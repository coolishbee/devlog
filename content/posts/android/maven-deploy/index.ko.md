...
summary: "제이센터에서 메이븐으로 이전하며 진행한 계정 준비, 서명과 배포 스크립트 구성을 정리합니다."
tags: ["게임펍", "안드로이드", "메이븐", "배포"]
categories: ["안드로이드"]
...
![안드로이드 SDK 메이븐 배포 기록 참고 화면](images/117414676-63b64200-af52-11eb-8529-4eaf4523e4b3.png)
...
![안드로이드 SDK 메이븐 배포 기록 참고 화면](images/117416035-ee4b7100-af53-11eb-8592-417e861f188c.png)
...
![안드로이드 SDK 메이븐 배포 기록 참고 화면](images/117418606-93ffdf80-af56-11eb-9503-6fcfe17cfa0c.png)
...
* [GPG 한글가이드](https://coolishbee.github.io/techblog/shell/gpg-usage/)
...
[패키지명 변경하기](https://coolishbee.github.io/techblog/android/android-package-refactor/)
...
![안드로이드 SDK 메이븐 배포 기록 참고 화면](images/117629562-41702e80-b1b5-11eb-8613-f112897204a2.png)
...
![안드로이드 SDK 메이븐 배포 기록 참고 화면](images/117629583-48973c80-b1b5-11eb-9933-6ab693b8f5c6.png)

검수 결과 실패 또는 성공에 대한 로그를 확인할 수 있고 성공시 Release 버튼이 활성화 된다.

![안드로이드 SDK 메이븐 배포 기록 참고 화면](images/117629658-58168580-b1b5-11eb-9eaf-29aad8f7c7b0.png)

물론 릴리즈하면 라이브로 배포가 되는 것이다.

![안드로이드 SDK 메이븐 배포 기록 참고 화면](images/117629675-5e0c6680-b1b5-11eb-921c-11f03b7f3564.png)
...
![안드로이드 SDK 메이븐 배포 기록 참고 화면](images/117634385-cfe6af00-b1b9-11eb-9299-546d0d82a00e.png)
...
[기술 블로그에서 원문 보기](https://coolishbee.github.io/techblog/android/maven-deploy/)
